...
function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      {/* Left brand */}
      <div className="relative hidden overflow-hidden lg:flex lg:flex-col lg:p-12" style={{ background: "var(--gradient-primary)" }}>
        ...
        <div className="relative flex flex-1 flex-col justify-center">
          <div className="max-w-md text-primary-foreground">
            ...
            <p className="mt-4 text-base text-primary-foreground/80">
              Compare accurate data on Indian engineering institutions. Analyze placements, fees, and rankings to find your best fit.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center bg-background p-6 md:p-10">
        <div className="w-full max-w-sm">
          <Link to="/colleges" className="mb-6 flex items-center gap-2 lg:hidden">
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-primary text-primary-foreground"><GraduationCap className="h-5 w-5" /></div>
            <span className="text-lg font-semibold">EduFind</span>
          </Link>
